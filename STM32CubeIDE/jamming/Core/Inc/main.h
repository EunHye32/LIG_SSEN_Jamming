...
#define NRF_RX_CSN_Pin GPIO_PIN_4
#define NRF_RX_CSN_GPIO_Port GPIOD
#define NRF_RX_CE_Pin GPIO_PIN_5
...
#define NRF_TX_CSN_Pin GPIO_PIN_3
#define NRF_TX_CSN_GPIO_Port GPIOB
#define NRF_TX_CE_Pin GPIO_PIN_4
#define NRF_TX_CE_GPIO_Port GPIOB
